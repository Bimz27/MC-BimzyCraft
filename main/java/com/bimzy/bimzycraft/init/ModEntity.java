...
public class ModEntity {
	...
	public static void registerEntities()
	{
		...
		registerEntity("ice_golem", EntityIceGolem.class, Reference.ENTITY_ICE_GOLEM, 50, 175144075, 063043000);
		registerEntity("magma_golem", EntityMagmaGolem.class, Reference.ENTITY_MAGMA_GOLEM, 50, 175144075, 063043000);
		registerEntity("arcane_golem", EntityArcaneGolem.class, Reference.ENTITY_ARCANE_GOLEM, 50, 175144075, 063043000);
	...
	private static void addSpawns() {
		...
		EntityRegistry.addSpawn(EntityEarthGolem.class, 100, 5, 20, EnumCreatureType.MONSTER);
		copySpawns(EntityEarthGolem.class, EnumCreatureType.MONSTER, EntityZombie.class, EnumCreatureType.MONSTER);
		
		EntityRegistry.addSpawn(EntityIceGolem.class, 100, 5, 20, EnumCreatureType.MONSTER);
		copySpawns(EntityIceGolem.class, EnumCreatureType.MONSTER, EntityZombie.class, EnumCreatureType.MONSTER);
		
		EntityRegistry.addSpawn(EntityMagmaGolem.class, 100, 5, 20, EnumCreatureType.MONSTER);
		copySpawns(EntityMagmaGolem.class, EnumCreatureType.MONSTER, EntityZombie.class, EnumCreatureType.MONSTER);
		
		EntityRegistry.addSpawn(EntityArcaneGolem.class, 100, 5, 20, EnumCreatureType.MONSTER);
		copySpawns(EntityArcaneGolem.class, EnumCreatureType.MONSTER, EntityZombie.class, EnumCreatureType.MONSTER);
	}
